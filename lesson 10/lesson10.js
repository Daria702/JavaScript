...
btn.onclick = function () {
    ...
    user.innerText = `${userName} ${userSurname} ${userAge}`;
...
document.addEventListener('+1', function () {
    let div = document.getElementById('cifra');
    let cifra = document.getElementById('cifra').value;
    div.innerText = cifra + 1;
    console.log(div)
});
...
// відмалювати всю інформацію про відвідування сторінки index.html. Інфу НЕ виводити в консоль, а побудувати дом структуру
// під кожну сессію
...
//
// *** (подібне було вище, але...будьте уважні в другій частині) створити сторінку з довільним блоком, в середині якого є
// значення "100грн"
